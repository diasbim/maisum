...
abstract final class Log {
  ...
  static void eLocal(
    ...
    _write(1000, tag, message, error: error, stack: stack, notifySink: false);
  }
  ...
  static void _write(
    ...
    Object? error,
    StackTrace? stack,
    bool notifySink = true,
  }) {
    dev.log(message, name: tag, level: level, error: error, stackTrace: stack);

    final sink = notifySink ? _sink : null;
    if (sink == null) return;
