...
exports.SeenContacts = exports.DEFAULT_DEDUP_RADIUS_METRES = exports.DUPLICATE_REASON_LABEL = exports.DUPLICATE_REASON = void 0;
...
exports.DUPLICATE_REASON = [
    'SAME_SOURCE_REFERENCE',
    'SAME_NAME_NEARBY',
    'SAME_NAME_NO_LOCATION',
];
exports.DUPLICATE_REASON_LABEL = {
...
exports.DEFAULT_DEDUP_RADIUS_METRES = 150;
/* --------------------------------------------------------------- distance */
...
function matchName(name) {
    const stripped = (0, prospecting_normalization_js_1.normalizeMatchName)(name);
    return stripped !== '' ? stripped : (0, prospecting_normalization_js_1.normalizeCompanyName)(name);
}
/** A candidate's position, or null when either half is missing. */
function pointOf(candidate) {
...
function dedupeCandidates(candidates, options = {}) {
    const radius = options.radiusMetres ?? exports.DEFAULT_DEDUP_RADIUS_METRES;
    const kept = [];
    const duplicates = [];
    for (const candidate of candidates) {
        ...
        for (let index = 0; index < kept.length; index++) {
            ...
            if (candidate.sourceReference !== null &&
            ...
            if (key === '' || matchName(existing.name) !== key)
                continue;
...
class SeenContacts {
    ...
    observe(fingerprint) {
        ...
        if (phoneSeen)
            return { duplicate: true, by: 'phone' };
        if (domainSeen)
            return { duplicate: true, by: 'domain' };
        return { duplicate: false, by: null };
    }
}
exports.SeenContacts = SeenContacts;
