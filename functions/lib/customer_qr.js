...
exports.createCustomerQrToken = createCustomerQrToken;
exports.verifyCustomerQrToken = verifyCustomerQrToken;
const crypto_1 = require("crypto");
function sign(encodedPayload, secret) {
    return (0, crypto_1.createHmac)('sha256', secret).update(`customer-qr-v1.${encodedPayload}`).digest('base64url');
}
function createCustomerQrToken(input) {
    const payload = {
        v: 1,
        sub: input.subject,
        iat: input.issuedAt,
...
function verifyCustomerQrToken(input) {
